...
$query=$db->prepare("SELECT * from kategori WHERE id=:id");
$query->execute(array(
    'id' =>@$_GET['id']
));
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Kategori Düzenleme<small></small></h3>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3"style="width: 60%">
                                         ...
                                         <input type="text" value="<?php echo $sor['kategori_adi']; ?>" name="kategori_adi_duzenle" class="form-control" id="exampleInputEmail1" placeholder="...">
                                        </div>
                                    </div>
                                </div>

                                <div class="card-footer">
                                    <button type="submit" name="kategori_duzenle" class="btn btn-info">Onayla</button>
                                </div>
                            </form>
                        </div>
                    </div>
