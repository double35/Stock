            ...
            <form method="post" action="netting/islem.php" class="form-horizontal form-label-left">
                <div class="card card-info">
                    ...
                    <div class="input-group" style="width: 70%;margin-top: 5px;margin-left: 5px">
                        ...
                        <select  name="urun_id" class="form-control" >
                            ...
                            foreach ($urun as $key => $value) { ?>
                                <option value="<?php echo $value['id']; ?>"><?php echo $value['urun_adi']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <br>
                    ...
                    <div class="input-group mb-3" style="width: 70%;margin-left: 5px">
                        ...
                        <select name="kasa_id" class="form-control" style="...">
                            ...
                            foreach ($kasa as $key => $value) { ?>
                                <option value="<?php echo $value['id']; ?>"><?php echo $value['kasa_adi']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <br>
                    <div class="input-group mb-3" style="width: 70%;margin-left: 5px">
                        ...
                        <select name="musteri_id" class="form-control" style="...">
                            ...
                            foreach ($musteri as $key => $value) { ?>
                                <option value="<?php echo $value['id']; ?>"><?php echo $value['musteri_ad']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <br>
                    ...
                    <div class="input-group mb-3 " style="width: 70%;margin-left: 5px">
                        ...
                        <select name="depo_id" class="form-control" style="...">
                            ...
                            foreach ($depo as $key => $value) { ?>
                                <option value="<?php echo $value['id']; ?>"><?php echo $value['depo_adi']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <br>
                    ...
                    <div class="input-group mb-3"style="width: 70%">
                        ...
                        <input type="text" name="adet" class="form-control" placeholder="Ürün Miktar">
                    </div>

                    <br>
                    <div class="input-group mb-3" style="width: 70%">
                        <label class="input-group-text" style="border-radius: 0%;margin-left: 5px;width: 10%">Fiyat</i></label>
                        <input type="text" name="fiyat" class="form-control" placeholder="Ürün Fiyat">
                    </div>

                    <button name="stok_kaydet"  type="submit" class="btn btn-info" style="width:10%;margin-bottom:10px;margin-left: 10px">Kaydet</button>
                </div>
    </div>
    </form>
    </div>
